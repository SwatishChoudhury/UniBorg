...
async def _(event):
    ...
    packname = f"@Sike9's Kitten Pack"
    packshortname = f"Sike_s_kitten_{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"@Sike9's Kitten Animated Pack"
        packshortname = f"sike_s_kitten{userid}_as"  # format: Uni_Borg_userid
